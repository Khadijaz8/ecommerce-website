...
Array.from(uperArrowR).forEach((element) => {
  element.addEventListener("click", function (e) {
    ...
    if (dropdownOptr.style.display === "none") {
      dropdownOptr.style.display = "block"; // Show the list
  } else {
      dropdownOptr.style.display = "none"; // Hide the list
  }
  });
});
...
Array.from(uperArrowCa).forEach((element) => {
  element.addEventListener("click", function (e) {
    ...
    if (dropdownOptca.style.display === "none") {
      dropdownOptca.style.display = "block"; // Show the list
  } else {
      dropdownOptca.style.display = "none"; // Hide the list
  }
  });
});
